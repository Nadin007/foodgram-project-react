...
DJOSER = {
    'LOGIN_FIELD': 'email',
    'SERIALIZERS': {
        'user_create': 'users.serializersUser.CustomUserCreateSerializer',
        'user': 'users.serializersUser.CustomUserSerializer',
        'current_user': 'users.serializersUser.CustomUserSerializer',
    },
    'PERMISSIONS': {
